 ...
 */
class RemajaFrame extends JFrame implements ActionListener {
    JLabel judul = new JLabel("Halaman Pembelian");
    JLabel kategori = new JLabel("Kategori");
    JLabel remaja = new JLabel("Majalah Remaja");
    JLabel lblharga = new JLabel("Harga");
    JLabel jml = new JLabel("Jumlah");
    JLabel harga = new JLabel(" Rp 15.200");
    ...
    JLabel ketharga = new JLabel(" Rp 15.200");
    ...
    RemajaFrame(){
        ...
        add(remaja);
        remaja.setBounds(220, 70, 200, 40);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try{
            ...
            Remaja beliremaja = new Remaja(jumlah);
            String hasil = String.valueOf(beliremaja);
        }catch(Exception ec){
